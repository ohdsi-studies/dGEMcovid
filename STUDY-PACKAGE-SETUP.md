...
- Set the `projectRootFolder` variable to the directory specific to your environment. In this example we are using `C:/dGEMcovid`. This root folder will serve a few purposes:
